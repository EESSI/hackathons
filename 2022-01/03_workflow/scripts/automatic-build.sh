...
# We get the information which architecture to build from the site-config file
...
# cp ${BASEDIR}/eessi/software-layer/EESSI-pilot-install-software-easystack.sh \${EESSI_TMPDIR}/eessi
...
echo \${EESSI_TMPDIR} \${EESSI_PILOT_VERSION} \${EESSI_SOFTWARE_SUBDIR} \${TARBALL}
exit 2
...
# Just print out the queue for the current user. 
echo "List of running jobs of $USER :"
squeue -u $USER
